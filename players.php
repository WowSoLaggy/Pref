<html>
	...
	<body>
		...
		for ($i = 0; $i < $num_players; $i++)
			...
			"</td><td width=70 align=center>".$players[$i]['score'].
			"</td><td width=40 align=center>".$players[$i]['games'].
			"</td><td width=50 align=center>".(round($players[$i]['wins'] / $players[$i]['games'] * 100)).
