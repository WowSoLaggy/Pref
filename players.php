<html>
	...
	<body class="light">
		...
		{
			$string = "<tr><td width=20 align=center>".($i + 1)."</td>";
			$string .= 
			...
			$string .=
					...
					")</td>";
			$string .=
					"<td width=110 align=center>".$players[$i]->games."<br>(".$players[$i]->total.
					")</td>";
			$string .=
					"<td width=75 align=center>".round($players[$i]->games / $num_games * 100)."%/".
					round($players[$i]->wins / $players[$i]->games * 100).
					"%</td>";
			$string .=
					"<td width=120 align=center>".$players[$i]->hill."<br>(".
					$players[$i]->hill_min."/".round($players[$i]->hill_avg)."/".$players[$i]->hill_max.
					")</td>";
			$string .=
					"<td width=120 align=center>".$players[$i]->balance."<br>(".
